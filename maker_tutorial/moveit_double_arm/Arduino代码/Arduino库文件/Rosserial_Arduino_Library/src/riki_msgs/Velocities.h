#ifndef _ROS_riki_msgs_Velocities_h
#define _ROS_riki_msgs_Velocities_h
...
namespace riki_msgs
{
  ...
  class Velocities : public ros::Msg
  {
    ...
    virtual const char * getType(){ return PSTR("riki_msgs/Velocities"); };
    virtual const char * getMD5(){ return PSTR("0ee8ad4cb7809be2d5a0a76352fea86a"); };
