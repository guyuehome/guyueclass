...
/***************************************
 *
 * Copy form ceres: ceres-solver-1.14.0/examples/slam/pose_graph_3d/pose_graph_3d.cc
 *
*/
namespace Ceres_pose_graph_3d {
    ...
    void BuildOptimizationProblem(const VectorOfConstraints& constraints,
        ...
        // constrain the gauge freedom. (发音： [ɡeɪdʒ]) This can be done by setting one of the poses
...
class Mapping_refine {
    ...
    pcl::PointCloud<_PointType> refine_pointcloud(std::map<int, pcl::PointCloud<_PointType>>& map_idx_pc, //所有finished keyframes
        ...
        if (it == map_idx_pc.end()) {
            ...
            pts_vec_opm = refine_pts(pts_vec_ori, //finished keyframe 存放的m_accumulated_point_cloud
