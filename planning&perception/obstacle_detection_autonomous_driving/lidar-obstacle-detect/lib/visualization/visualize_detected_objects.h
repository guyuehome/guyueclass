...
private:
  ...
  std_msgs::ColorRGBA label_color_, cube_color_,box_color_, hull_color_, arrow_color_, centroid_color_, model_color_;
  ...
  visualization_msgs::MarkerArray ObjectsToCubes(const autoware_msgs::DetectedObjectArray &in_objects);
...
public:
  ...
  void visualizeDetectedObjs(const autoware_msgs::DetectedObjectArray &in_objects,visualization_msgs::MarkerArray &visualization_markers);
};
