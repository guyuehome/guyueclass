#ifndef _ROS_riki_msgs_PID_h
#define _ROS_riki_msgs_PID_h
...
namespace riki_msgs
{
  ...
  class PID : public ros::Msg
  {
    ...
    virtual const char * getType(){ return PSTR("riki_msgs/PID"); };
    virtual const char * getMD5(){ return PSTR("a559df187bdf63f426d5f304b6b28bb4"); };
